    ...
    <div>
      <div className="pb-6 bg-white sm:pb-8 lg:pb-12">
        <div className="px-4 mx-auto max-w-screen-2xl md:px-8">
          <section className="flex flex-col justify-between gap-6 mb-8 lg:flex-row sm:gap-10 md:gap-16 md:mb-16">
            {/* <!-- content - start --> */}
            ...
            {/* <!-- image - start --> */}
            <div className="h-48 overflow-hidden bg-gray-100 rounded-lg shadow-lg xl:w-5/12 lg:h-96">
              <img
                src={
                  props.imgSrc ||
