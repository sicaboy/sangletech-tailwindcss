  ...
  const posts = [
    {
      ...
      readingTime: props.blogOneReadingTime,
      author: {
    ...
    },
    {
      ...
      readingTime: props.blogTwoReadingTime,
      author: {
    ...
    },
    {
      ...
      readingTime: props.blogThreeReadingTime,
      author: {
        ...
        {props.buttonName && (
          <div className="pt-32 text-center">
            <Link href={props.buttonSrc || "/"}>
              <a className="inline-flex items-center px-5 py-3 bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none">
                <svg
