...
function SowXO() {
  ...
  const textTwo = {
    rightCaption: "Cuộc Lội Ngược Dòng Ngoạn Mục",
...
`,
  ...
  const textFive = {
    leftCaption: "Viên Kim Cương X.0",
    leftTitle: "4 Chặng Đường - Hành Trình Làm Giàu X.0",
    leftDescription: `Hành trình này gồm có 4 chặng đường: 
    <br></br>◈   **Tư Duy**
    <br></br>◈   **Kỹ Năng**
    <br></br>◈   **Sự Nghiệp**
    <br></br>◈   **Đầu Tư**
    ...
    leftAlt: "Logo Hanh Trinh Lam Giau Chu Thich Tung Chang Duong",
  };

  const textSix = {
    rightCaption: "Chặng #1",
    rightTitle: "TƯ DUY",
    rightDescription: `Tư duy cũng như nền móng của một căn nhà: Nhà càng cao, nền móng phải càng vững. Sang luôn quan niệm rằng, **tư duy của một người cao đến đâu thì tài chính của họ cũng cao đến đó**. 
  ...
  const textEight = {
    ...
    rightAlt: "Logo Chang Duong 3",
  };

  const textNine = {
    leftCaption: "Chặng #4",
    leftTitle: "ĐẦU TƯ",
    leftDescription: `Rất nhiều người nghĩ rằng, chỉ khi bạn giàu có, bạn mới nên đầu tư. Nhưng Sang không nghĩ vậy. Sang lại nghĩ rằng, chỉ khi đầu tư, thì bạn mới giàu có.
  ...
  return (
    <Layout>
      ...
      <AlternativeSideBySideWithVideoOrImg {...textNine} {...textTen} />
    </Layout>
  );
}
